...
layout.dbu = 0.001
top = layout.create_cell("oa_sar8_acore11")
...
via2(119.2, TRKB_S)                                               # from the trkb drop (119.2 M2 runs -35.4..-14.9)
...
layout.write("oa_sar8_acore11.gds")
b = top.dbbox()
print(f"acore11: {b.width():.0f} x {b.height():.0f} um = {b.width()*b.height()/1e6:.3f} mm2")
