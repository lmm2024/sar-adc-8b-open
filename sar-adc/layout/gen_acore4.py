...
layout.dbu = 0.001
top = layout.create_cell("oa_sar8_acore4")
...
rect("m1", 2.6, SWY - 2.2, 305.5, SWY - 1.6)                  # VSS (+bstrap merge)
rect("m1", 2.6, SWY + 12.4, 301.0, SWY + 13.0)                # VDD (+bstrap feed)
...
rect("m3", 5.0, TRKB_Y - 0.2, 256.4, TRKB_Y + 0.2)            # trkb: cells+TG+bstrap ckb
...
rect("m3", 195.8, -19.2, 256.2, -18.8)
via2(196.0, -19.0)
vwire(196.0, -19.0, -13.3)
via2(196.0, -13.3)
...
layout.write("oa_sar8_acore4.gds")
b = top.dbbox()
print(f"acore4: {b.width():.0f} x {b.height():.0f} um = {b.width()*b.height()/1e6:.3f} mm2")
