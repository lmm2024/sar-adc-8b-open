...
layout.dbu = 0.001
top = layout.create_cell("oa_sar8_core5")

layout.read("oa_sar8_acore5.gds")
layout.read("/foss/designs/sar-adc/logic/final/gds/sar_ctrl.gds")
ac = layout.cell("oa_sar8_acore5")
...
TRACK_Y = {k: -57.0 - 1.3 * k for k in range(8)}
...
layout.write("oa_sar8_core5.gds")
b = top.dbbox()
print(f"core5: {b.width():.0f} x {b.height():.0f} um = {b.width()*b.height()/1e6:.3f} mm2")
