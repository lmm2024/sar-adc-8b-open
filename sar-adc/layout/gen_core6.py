...
layout.dbu = 0.001
top = layout.create_cell("oa_sar8_core6")

layout.read("oa_sar8_acore6.gds")
layout.read("/foss/designs/sar-adc/logic/final/gds/sar_ctrl.gds")
ac = layout.cell("oa_sar8_acore6")
...
STUB_X = {0: 17.1, 1: 30.9, 2: 44.7, 3: 58.5, 4: 72.3,
          5: 86.1, 6: 99.9, 7: 113.7}                  # cell west stubs (acore3)
CTL_Y = -14.1
for k in range(8):
...
layout.write("oa_sar8_core6.gds")
b = top.dbbox()
print(f"core6: {b.width():.0f} x {b.height():.0f} um = {b.width()*b.height()/1e6:.3f} mm2")
