...
layout.dbu = 0.001
top = layout.create_cell("oa_sar8_core7")
...
L = {}
for num, name in ((10, "m2"), (29, "v2"), (30, "m3"), (49, "v3"), (50, "m4")):
...
DROP_X = {0: 192.5, 1: 190.3, 2: 188.1, 3: 185.9, 4: 183.7,
          5: 181.5, 6: 179.3, 7: 177.1}                 # M4 drops at rail midpoints (clear of via pads)
TRACK_Y = {k: -38.0 - 1.3 * k for k in range(8)}
STUB_X = {0: 7.0, 1: 20.8, 2: 34.6, 3: 48.4, 4: 62.2,
          5: 76.0, 6: 89.8, 7: 103.6}                  # cell west stubs (acore3)
CTL_Y = -14.1
for k in range(8):
...
layout.write("oa_sar8_core7.gds")
b = top.dbbox()
print(f"core7: {b.width():.0f} x {b.height():.0f} um = {b.width()*b.height()/1e6:.3f} mm2")
