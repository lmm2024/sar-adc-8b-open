...
ly = pya.Layout()
ly.read("oa_sar8_core10.gds")
top_ = ly.cell("oa_sar8_core10")
drop = ("sa_comp", "sw_bitcell", "sw_bitcell10", "sw_tg", "bstrap", "sar_ctrl")
n = 0
for host in (top_, ly.cell("oa_sar8_acore9")):
...
top_.name = "oa_sar8_pas10"
ly.write("oa_sar8_pas10.gds")
print("wrote oa_sar8_pas10.gds", top_.dbbox())
