...
ly = pya.Layout()
ly.read("oa_sar8_core4.gds")
top_ = ly.cell("oa_sar8_core4")
drop = ("sa_comp", "sw_bitcell", "sw_bitcell10", "sw_tg", "bstrap", "sar_ctrl")
n = 0
for host in (top_, ly.cell("oa_sar8_acore4")):
...
top_.name = "oa_sar8_pas4"
ly.write("oa_sar8_pas4.gds")
print("wrote oa_sar8_pas4.gds", top_.dbbox())
