...
ly = pya.Layout()
ly.read("oa_sar8_core5.gds")
top_ = ly.cell("oa_sar8_core5")
drop = ("sa_comp", "sw_bitcell", "sw_bitcell10", "sw_tg", "bstrap", "sar_ctrl")
n = 0
for host in (top_, ly.cell("oa_sar8_acore5")):
...
top_.shapes(m3l).insert(pya.DText("vcm", pya.DTrans(pya.DVector(300.0, -9.82))))

top_.name = "oa_sar8_pas5"
ly.write("oa_sar8_pas5.gds")
print("wrote oa_sar8_pas5.gds", top_.dbbox())
