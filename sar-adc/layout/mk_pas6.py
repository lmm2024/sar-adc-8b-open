...
ly = pya.Layout()
ly.read("oa_sar8_core6.gds")
top_ = ly.cell("oa_sar8_core6")
drop = ("sa_comp", "sw_bitcell", "sw_bitcell10", "sw_tg", "bstrap", "sar_ctrl")
n = 0
for host in (top_, ly.cell("oa_sar8_acore6")):
...
SW_X = {"term": 4.0, "b0": 17.8, "b1": 31.6, "b2": 45.4, "b3": 59.2,
        "b4": 73.0, "b5": 86.8, "b6": 100.6, "b7": 114.4}
...
top_.shapes(m3l).insert(pya.DText("vcm", pya.DTrans(pya.DVector(180.0, -9.82))))

top_.name = "oa_sar8_pas6"
ly.write("oa_sar8_pas6.gds")
print("wrote oa_sar8_pas6.gds", top_.dbbox())
