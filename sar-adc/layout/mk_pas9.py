...
ly = pya.Layout()
ly.read("oa_sar8_core9.gds")
top_ = ly.cell("oa_sar8_core9")
drop = ("sa_comp", "sw_bitcell", "sw_bitcell10", "sw_tg", "bstrap", "sar_ctrl")
n = 0
for host in (top_, ly.cell("oa_sar8_acore8")):
...
top_.name = "oa_sar8_pas9"
ly.write("oa_sar8_pas9.gds")
print("wrote oa_sar8_pas9.gds", top_.dbbox())
